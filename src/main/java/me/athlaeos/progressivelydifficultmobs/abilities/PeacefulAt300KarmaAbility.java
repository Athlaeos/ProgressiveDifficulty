...
public class PeacefulAt300KarmaAbility extends Ability {
    ...
    public PeacefulAt300KarmaAbility(){
        this.name = Utils.chat("&a&lPeaceful to 300+ karma");
        this.description = Arrays.asList(
                ...
                Utils.chat("&7with &a300&7 or more karma (good karma)"));
