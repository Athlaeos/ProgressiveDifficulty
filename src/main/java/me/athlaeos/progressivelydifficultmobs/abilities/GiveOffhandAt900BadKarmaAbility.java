...
public class GiveOffhandAt900BadKarmaAbility extends Ability {
    ...
    public GiveOffhandAt900BadKarmaAbility(){
        this.name = Utils.chat("&c&lGive off-hand item to 900- karma");
        this.description = Arrays.asList(
                ...
                Utils.chat("&7-900 or less karma when"),
