...
public class CustomizablePotionEffectRetaliationAbility extends Ability {

    private final PotionEffectType effect;
    private final int amplifier;
    private final int duration;
    public CustomizablePotionEffectRetaliationAbility(String name, List<String> description, Material icon, PotionEffectType effect, int amplifier, int duration){
        this.name = name;
