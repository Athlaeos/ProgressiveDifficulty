...
public class GiveOffhandAt300BadKarmaAbility extends Ability {
    ...
    public GiveOffhandAt300BadKarmaAbility(){
        this.name = Utils.chat("&c&lGive off-hand item to 300- karma");
        this.description = Arrays.asList(
                ...
                Utils.chat("&7-300 or less karma when"),
