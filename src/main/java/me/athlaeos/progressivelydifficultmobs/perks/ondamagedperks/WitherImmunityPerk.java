...
public class WitherImmunityPerk extends Perk {
    public WitherImmunityPerk(){
        this.id = 1041;
        ...
        this.description = Utils.seperateStringIntoLines(Utils.chat("&7Players with this perk" +
                " are immune to wither damage"), 36, "&7");
        this.name = "wither_immunity";
    ...
    public void execute(Event e) {
        if (e instanceof EntityDamageEvent){
            ...
            if (!event.isCancelled()){
                if (WorldguardManager.getWorldguardManager().isLocationInRegionWithFlag(event.getEntity().getLocation(), "pdm-immunity-wither-deny")
